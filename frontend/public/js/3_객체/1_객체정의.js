/*
	JS : 객체 지향 언어 [ OOP : Object Oriented Programming ]
		...
		대량화/ 자동화 / =====> 객체지향 프로그래밍 적합하다.
			=> 미리 설계(클래스) 하고 컴퓨더 설계 주입해서 설계 기반으로 형태 (객체) 생성
		ex)
			현대 소나타
				소나타생성설계 = 클래스 생성
				A소나타 = 객체, B소나타=객체
...
console.log( '비밀번호속성 호출' + 객체1.비밀번호 ) // 객체내 속성 알고있으면 데이터 호출 가능하다.
	//console : 내장객체 -> console객체에서 log()함수 호출 
	// document : 내장객체 -> document 객체에서 querySelstor() 함수 호출
	// vs
console.log( 배열1[0] )
...
// 5. 객체내 속성 삭제
delete 객체1.주소;	//객체내 속성이 삭제되면 데이터도 같이 삭제
console.log( 객체1 )
