...
public class Ex1_제한된타입파라미터 {
	...
	// - 제네릭 메소드 정의 [제한된 타입 파라미터 ]
		//< T extends Number >  : Number 클래스 포함해서 Number 자손 클래스의 객체들만 허용
	...
	public static void main(String[] args) {
		...
		Integer i = 3; // Integer 클래스는 Number 클래스의 자손
		Double d = 3.0; //Double 클래스는 Number 클래스의 자손
		String s = "aa"; //String 클래스는 Number 클래스 자손 아니다.[x]
