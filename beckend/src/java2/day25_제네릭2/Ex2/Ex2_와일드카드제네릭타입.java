...
public class Ex2_와일드카드제네릭타입 {
	...
	public static void main(String[] args) {
		...
		// 3. 모든 객체가 지원 가능한 코스등록 함수
		Course.registerCourse1(applicant);
			
		// ----- 코스1 : ( 모든 지원서객체( 사람 , 직장인 , 학생 , 고등학생 , 중학생 ) 누구나 등록 가능한 코스
		...
		// ----- 코스2 : 학생만 신청 가능
			...
			//지원서객체중에 Student 객체와 Student 자손객체만 가능 [ Person , Worker 불가능 ]
		...
		// ----- 코스3 : 직장인 및 일반인만 신청가능
			...
			//지원서객체중에 Worker 객체 외 Worker 부모객체 만 가능 [ Student , HighStudent , MiddleStudent ]
