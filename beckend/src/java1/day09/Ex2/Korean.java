...
public class Korean {
	...
	String name;				// 2. 객체마다 다른 값을 가져야한다면	/ 객체마다 다른 값을 가져야 한다면 / 객체의 필드값 기본값 -> 생성자 이용 권장
	String ssn;
	// 2. 생성자
		//1. 기본 생성자 = 깡통생성자
	public Korean() { }
