...
public class Ex2_타입 { // class s
	...
	public static void main(String[] args) {// main s
		...
		int var1 = 0b1011; // 데이터 앞에 0b = 이진수 1011[2] -> 11[10]
		System.out.println("var1 : " + var1);
		
		int var2 = 0206;	//데이터 앞에 0 = 8진수
			System.out.println("var2 : " + var2);
		
		int var3 = 365;	// 암것도 없으면 10진수
		...
		//byte b3 = 200; System.out.println("b3" + b3); //오류 : 허용범위 벗어남
	
		//short 타입 [ -32,768 ~ 32,767 ]
		short s1 = 3200; System.out.println("s1 : " + s1 );
		//short s2 = -50000; System.out.println("s2 : " + s2 ); //오류 : Type missmatch : 허용범위 벗어남
		
		//int 타입 [ 대략 +- 21억 정도 ] * 정수 기본타입 : 1.우리 코드로 적은 숫자
		int i1 = 200000000; System.out.println("i1 : " + i1);
		int i2 = 300000000; System.out.println("i2 : " + i2);
	
		//long 타입 [ 대략 21억 이상 정도 ]
		long l1 = 10; System.out.println("l1 : " + l1 );
		long l2 = 300000000; //직접 작성한 정수 30억은 int 타입 -> 기본/자동
		long l3 = 300000000L; //직접 작성한 정수를 long 타입 변경 -> 정수 뒤에 L 붙이기
...
/*
 	타입/자료형 : 데이터 저장할때 사용되는 메모리 크기
 		...
 		논리타입
 			boolean 1비트			0 = false[0] / true[1]
 		
 		문자타입
 			char	2바이트			[0 ~65535 ] 유니코드
 
 		문자열타입
 			String	클래스[글자수 다름] 제한없음
	...
	//용량단위 :
 	...
 	//인코딩 : 2진수를 문자로 표현하는 방법
 	 	...
 	 	아스키코드	: 7비트(확장 8비트) -> 128문자 표현	1바이트 = 특수문자/숫자/영문
