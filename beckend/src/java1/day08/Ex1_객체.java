...
/*
	...
	객체지향 프로그래밍 : OOP 
		...
		- Ex1) 1블럭 = 객체 1개	=> 블력 여러개 = 레고완성품
	객체란 : 물리적으로 존재하거나 개념적으로 존재하는 것중 식별 가능한것
			- 물리적인 존재 : 자동차 , 자전거 , 책 , 사람 = 손에 잡히는 형태
			- 개념적인 존재 : 학과 , 강의 , 주문 = 손에 안잡힌는 형태
	...
	객체지향 프로그래밍의 특징
		1. 캡슐화	: 필드,동작 하나로 묶어서 다른 객체로 감추는것
		2. 상속	: 상위 객체로부터 필드, 동작 물려 받아 하위 객체가 사용 할 수 있는 것
