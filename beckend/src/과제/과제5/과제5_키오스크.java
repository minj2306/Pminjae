	...
	public static void main(String[] args) {
		...
		while(true) {
			...
			if(ch == 1) {
				...
				String 콜라가격 = 콜라.split(",")[0];
				String 콜라재고 = 콜라.split(",")[1];
				String 콜라바구니 = 콜라.split(",")[2];
				
				if(!콜라재고.equals("0")) {
					
					int 콜라가방 = Integer.parseInt(콜라바구니);
					int 콜라창고 = Integer.parseInt(콜라재고);
					int 콜라머니 = Integer.parseInt(콜라가격);
					콜라가방++;
					콜라창고--;
					콜라머니 = 콜라가방*콜라머니;
					
					콜라가격 = String.valueOf(콜라머니);
					콜라재고 = String.valueOf(콜라창고);
					콜라바구니 = String.valueOf(콜라가방);
