...
public class Level2_4 {
	...
	public static void main(String[] args) {
		...
		if(player.equals("가위") && com == 2 ||
				player.equals("바위") && com == 0 ||
				player.equals("보") && com == 1) 
						{System.out.println("result)player 승리");}
		else if(player.equals("가위") && com == 1 ||
				player.equals("바위") && com == 2 ||
				player.equals("보") && com == 0) 
						{System.out.println("result)com 승리");}
		else {System.out.println("result)비겼다.");}		
