		...
		while( true ) { // 무한루프 [ 종료조건 : 4 입력시 break; ] 
			...
			if(ch ==1) {//if 1 s
				...
				if(계좌번호.equals(account)){
					System.out.print(">>>>예금할 금액 : "); int 예금 =scanner.nextInt();
							balance += 예금;
				}
				else if(!계좌번호.equals(account)) {
			...
			if(ch ==2) {//if 2 s
				...
				if(계좌번호.equals(account)){//if 2-1 s
					
					System.out.print(">>>>비밀번호 : "); short 비밀번호 = scanner.nextShort();
					
					if(비밀번호 == password) {
						
					System.out.print(">>>>출금할 금액 : "); int 출금 =scanner.nextInt();
					...
					else if(비밀번호 != password) {System.out.println("비밀번호가 틀렸습니다.");}
				}//if 2-1 e
				else if(!계좌번호.equals(account)) {
					System.out.println(">>>>없는 계좌번호 입니다.");
					}
			...
			if(ch ==3) {//if 3 s 
				...
				System.out.print(">>>>확인할 계좌번호 : "); String 계좌번호 = scanner.next();
